module.exports = {
    ...
    remap: function (mappings) {
        ...
        for (var d = 0; d < mappings.acts_in.length; d++) {
            mappings.acts_in[d].movie_id = helpers.lookup(mappings.movies, "id", mappings.acts_in[d].movie_id).new_id;
            mappings.acts_in[d].actor_id = helpers.lookup(mappings.actors, "id", mappings.acts_in[d].actor_id).new_id;
        }
        ...
        for (var e = 0; e < mappings.directs.length; e++) {
            mappings.directs[e].movie_id = helpers.lookup(mappings.movies, "id", mappings.directs[e].movie_id).new_id;
            mappings.directs[e].director_id = helpers.lookup(mappings.directors, "id", mappings.directs[e].director_id).new_id;
        }
        ...
        for (var mt = 0; mt < mappings.movie_topics.length; mt++) {
            mappings.movie_topics[mt].movie_id = helpers.lookup(mappings.movies, "id", mappings.movie_topics[mt].movie_id).new_id;
            mappings.movie_topics[mt].topic_id = helpers.lookup(mappings.topics, "id", mappings.movie_topics[mt].topic_id).new_id;
        }
        ...
        for (var ms = 0; ms < mappings.produces.length; ms++) {
            mappings.produces[ms].movie_id = helpers.lookup(mappings.movies, "id", mappings.produces[ms].movie_id).new_id;
            mappings.produces[ms].studio_id = helpers.lookup(mappings.studios, "id", mappings.produces[ms].studio_id).new_id;
        }
    ...
    buildScript: function (script, mappings) {
